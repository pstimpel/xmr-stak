...
#define VERSION_LONG  XMR_STAK_NAME "/" XMR_STAK_VERSION "-pstimpel/" XMRSTAK_PP_TOSTRING(GIT_COMMIT_HASH) "/" XMRSTAK_PP_TOSTRING(GIT_BRANCH) "/" OS_TYPE "/" XMRSTAK_PP_TOSTRING(BACKEND_TYPE) "/" COIN_TYPE "/"
#define VERSION_SHORT XMR_STAK_NAME " " XMR_STAK_VERSION "-pstimpel " XMRSTAK_PP_TOSTRING(GIT_COMMIT_HASH)
#define VERSION_HTML "v" XMR_STAK_VERSION "-pstimpel-" XMRSTAK_PP_TOSTRING(GIT_COMMIT_HASH)
